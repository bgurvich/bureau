...
class extends Component
{
    ...
    public function save(bool $andContinue = true): void
    {
        ...
        // Read metadata BEFORE store() — store() moves the temp file, after
        // which getSize()/getMimeType() on the original $photo instance fail
        // with "Unable to retrieve file_size".
        ...
        $media = Media::create([
            ...
            'size' => $size,
            'captured_at' => now(),
            // Inventory photos are non-textual — don't enqueue Tesseract on these.
            'ocr_status' => 'skip',
        ]);
